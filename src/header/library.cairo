...
namespace internal:
    ...
    func should_skip_checks{
        ...
        # Skip if block already processed
        let (stored_block_header : BlockHeader) = BlockHeaderVerifier.block_header_by_hash(
    ...
    func genesis_block_header{range_check_ptr}(genesis_block_header : BlockHeader):
        ...
        let (genesis_merkel_root : Uint256) = felt_to_uint256(
